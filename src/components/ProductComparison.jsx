          ...
          <table className="comparison-table">
            <thead>
              <tr>
                ...
                {/* Полный видеокурс - пока не готов */}
                {/* <th className="product-header">
                  <div className="product-name">Полный видеокурс</div>
                  <div className="product-price">14 999₽</div>
                  <div className="old-price">22 000₽</div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colSpan="3">Постепенно от 15 минут и выше, чтобы всегда быть в методе</td>
              </tr>
