            ...
            <div className="lg:w-1/2">
              ...
              <div className="text-xl text-gray-600 space-y-4">
                ...
                <p className="font-medium text-gray-800">
                  Важно: метод Бутейко — это не замена врачебной помощи. Я не врач. Все назначения остаются за вашим доктором, любые изменения в приёме лекарств — только с его разрешения.
                </p>
                <p>
